...
/**
 * The <code>Bistream</code> class is responsible for parsing an MPEG audio bitstream. <b>REVIEW:</b> much of the parsing currently occurs in the various decoders. This should be moved into this class and associated inner classes.
 */
