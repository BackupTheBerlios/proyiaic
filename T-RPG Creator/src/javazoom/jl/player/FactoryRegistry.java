...
/**
 * The <code>FactoryRegistry</code> class stores the factories for all the audio device implementations available in the system.  <p> Instances of this class are thread-safe. 
 * @since  0.0.8
 * @author  Mat McGowan
 */
