...
/**
 * The <code>AudioDeviceBase</code> class provides a simple thread-safe implementation of the <code>AudioDevice</code> interface.  Template methods are provided for subclasses to override and in doing so provide the implementation for the main operations of the <code>AudioDevice</code> interface. 
 * @since  	0.0.8
 * @author  	Mat McGowan
 */
/*
