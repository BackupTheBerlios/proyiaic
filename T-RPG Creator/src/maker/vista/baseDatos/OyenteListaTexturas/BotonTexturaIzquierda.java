 ...
 * @author  David García
 */
public class BotonTexturaIzquierda implements ActionListener {
	...
	public BotonTexturaIzquierda(PanelTexturas texturas, File directorio, BotonTextura superf) 
	{
		this.padre = texturas;
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		padre.setPath_lateral_izquierdo(directorio.getAbsolutePath() + "\\Imagenes\\Texturas\\" + pans.getSelected());
		boton.setTextura(new File(padre.getPath_lateral_izquierdo()));
