 ...
 * @author  David García
 */
public class BotonTexturaDerecha implements ActionListener {
	...
	public BotonTexturaDerecha(PanelTexturas texturas, File directorio, BotonTextura superf) 
	{
		this.padre = texturas;
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		padre.setPath_lateral_derecho(directorio.getAbsolutePath() + "\\Imagenes\\Texturas\\" + pans.getSelected());
		boton.setTextura(new File(padre.getPath_lateral_derecho()));
