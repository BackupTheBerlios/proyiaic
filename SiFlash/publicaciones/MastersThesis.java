...
/**
 * Representa una tesis de maestría o proyecto fin de carrera.
...
//			if (proyecto != null) proyectos.add(proyecto);
			...
			MastersThesis mas1 = new MastersThesis(idDoc,referencia,doi,title,year,month,URL,abstracts,note,claves,user,proyecto,autores,address,school,type);
			vector.add(mas1);
...
//				if (proyecto != null) mas1.addProyect(proyecto);
	 ...
	 */		
	public MastersThesis(int idDoc, String referencia, String doi, String title,
	...
	public String obligatoriosRellenos()
	{
		if (title == null)
			...
			return "Error: 'school' es un campo obligatorio.";
		else if (year == null)
