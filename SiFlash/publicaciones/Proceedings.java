...
public class Proceedings extends Publication 
{
	...
	/**
	 * @return Organization del documento.
	 */
...
//		vector.add(str1);
	...
	/**
	 * Genera una conjunto de Proceedings a partir del resultado obtenido al realizar una consulta 
	 * en la base de datos.
