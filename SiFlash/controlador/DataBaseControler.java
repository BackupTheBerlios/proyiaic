...
public class DataBaseControler
{
	 ...
	 */
	public Vector<Publication> consultaDocumentos(String idDoc, String proyecto, int tipo_publicaciones, final Vector<AutorEditor> autores, final Vector<AutorEditor> editores, String title, final boolean parecido_title, String referencia, String DOI, String publisher, String journal, Vector<String> years, String volume, String series, String address, String organization, String school, String bookTitle, Vector<String> keys, boolean parecido_publisher, boolean parecido_series, boolean parecido_address, boolean parecido_journal, boolean parecido_volume, boolean parecido_school, boolean parecido_bookTitle, boolean parecido_organization, boolean parecido_keys, String user) throws BDException, NonExistingElementException 
	{
		...
		try{
			...
			return consultor.getPublicaciones(idDoc, proyecto, tipo_publicaciones, v_authors, v_editors, title, parecido_title, referencia, DOI, publisher, parecido_publisher, journal, parecido_journal, years, volume, parecido_volume, series, parecido_series, address, parecido_address, organization, parecido_organization, school, parecido_school,keys, bookTitle, parecido_bookTitle, user, conn);
		}finally{
	...
	{
		Vector<Publication> publicaciones = consultaDocumentos(null, proyecto, CodigosDatos.codSumaTodasPublicaciones, null, null, null, false, null, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, false, false, false, false, false, null);
	...
	public String obtenerListaPublicacionesUsuario(String  user)
	{
		try
		{
			Vector<Publication> publicaciones = consultaDocumentos(null, null, CodigosDatos.codSumaTodasPublicaciones, null, null, null, false, null, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, false, false, false, false, false, user);
	...
	public String obtenerBibtex(String id_doc)
	{
		try
		{
			Vector<Publication> v = consultaDocumentos(id_doc, null, CodigosDatos.codSumaTodasPublicaciones, null, null, null, false, null, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, false, false, false, false, false, null);
