...
public class DataBaseControlerTest {
	...
	public void testConsultaDocumentos() {
		...
		v1.add("str1");
		try {
			db_controler.consultaDocumentos(CodigosDatos.codInproceedings, v1, null, null, true, null, null, -1, -1, null, null, null, null, null, -1, -1, null, null, null, null, null, true, true, true, true, true, true, true, true);
		} catch (BDException e) {
			fail ("BDException");
